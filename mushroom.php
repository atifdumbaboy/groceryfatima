...
<body>
    ...
    <span>›</span>
    <a href="mushroom.php">Mushroom</a>
</div>
...
<div class="item">
    <div class="row">
        <div class="col-12 col-sm-5">
            <div class="image">
            <img src="Media/mushroom.png" class="img-fluid" alt="Grapes">
        </div>
        </div>
        <div class="col-12 col-sm-7">
            ...
            <p><br><br><br>
              Indulge in the exquisite taste of our farm-fresh Mushrooms, a true testament to our commitment to quality and authenticity. Grown with passion and precision on our own fields, these Mushrooms carry the essence of nature's goodness straight to your table.</p>
            <div class="rating">
