...
<div class="item">
    <div class="row">
        <div class="col-12 col-sm-5">
            <div class="image">
            <img src="Media/peas.png" class="img-fluid" alt="Grapes">
        </div>
        </div>
        <div class="col-12 col-sm-7">
            <div class="description">
            <h1 class="title">Peas</h1>
            <p><br><br><br>
              Indulge in the exquisite taste of our farm-fresh Peas, a true testament to our commitment to quality and authenticity. Grown with passion and precision on our own fields, these Peas carry the essence of nature's goodness straight to your table.</p>
            <div class="rating">
